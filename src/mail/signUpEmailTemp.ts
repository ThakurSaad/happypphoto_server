  ...
  <html>
    ...
    <body>
      <div class="container">
        ...
        <h1>Welcome to Fridge Fillers</h1>
        <p>Hello, ${data.user}</p>
        <p>Thank you for registering with Fridge Fillers. To activate your account, please use the following activation code:</p>
        ...
        <p>Thank you,<br>The Fridge Fillers Team</p>
      </div>
      <div class="footer">
        <p>&copy; Fridge Fillers - All Rights Reserved.</p>
        <p>
